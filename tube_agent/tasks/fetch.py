...
def run_pipeline_task(self, job_id: str, handle: str, config: dict):
    ...
    try:
        result = run_full_pipeline(
            ...
            skip_comments=config.get("skip_comments", True),
            skip_summaries=config.get("skip_summaries", True),
            fetch_transcript_data=config.get("fetch_transcripts", True),
            transcript_languages=config.get("transcript_languages") or ["ko", "en"],
